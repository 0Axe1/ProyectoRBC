<?php
    ...
    $paginasPermitidas = ['dashboard', 'clientes', 'pedidos', 'inventario', 'reportes', 'usuarios'];
...
<?php
    // --- ¡NUEVO! Cargar el JS específico de la página si existe ---
    $js_file_path = 'js/pages/' . $paginaActual . '.js';
    if (file_exists($js_file_path)) {
        // Usamos e() por seguridad, aunque el path es generado internamente
