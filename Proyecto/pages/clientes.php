...
// --- ¡CAMBIO! Se eliminó la lógica de mensajes GET ---

// --- ¡MODIFICADO! CONSULTA OPTIMIZADA CON LEFT JOIN ---
$sql = "SELECT
            c.id_cliente,
                ...
                <?php if ($stmt && $stmt->rowCount() > 0) : ?>
                    <?php while($cliente = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                        <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4"><?php echo e($cliente['nit_ruc'] ?? 'N/A'); ?></td>
                            <td class="px-6 py-4"><?php echo e($cliente['contacto'] ?? 'N/A'); ?></td>
                    ...
                    <?php endwhile; ?>
                <?php else : ?>
                    <tr><td colspan="5" class="px-6 py-4 text-center">No hay clientes registrados.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
