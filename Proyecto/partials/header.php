...
<html lang="es" class=""> <head>
    ...
    <title><?php echo e(ucfirst($paginaActual)); ?> - Sistema RBC</title>
        ...
        <header class="p-3">
            <div class="flex items-center justify-between">
                <nav class="flex items-center space-x-1">
                    ...
                    <!-- 2. MENÚ CONDICIONAL (¡MODIFICADO! Usa permisos) -->
                    <?php if (isset($_SESSION['permisos']) && in_array('ver_usuarios', $_SESSION['permisos'])): ?>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-gray-600 dark:text-gray-300 text-sm hidden sm:inline"><?php echo e($_SESSION['username'] ?? 'Usuario'); ?></span>
                    </div>
